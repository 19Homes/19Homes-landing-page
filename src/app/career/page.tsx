...
export default function Page() {
  return (
    <main>
      ...
      <section className="mt-20 flex w-full max-w-[1512px] items-center gap-8 px-14">
        <ImageGrid />
        <div className="flex flex-col gap-4">
          ...
          <p className="font-montserrat text-black-75 text-2xl font-normal">
            Become an agent with 19Homes and help us reach more people. We are a
            fast growing community and your progress and success are assured
            with us.
          </p>
