...
export default function FeatureCard({ title, description, image }: CardBase) {
  return (
    <article className="flex w-full max-w-[343px] shrink-0 flex-col items-center justify-center gap-6 rounded-4xl p-4.5 shadow-[0_4px_4px_rgba(0,0,0,0.25)] lg:w-[450px] lg:max-w-[450px] lg:gap-8 lg:p-6">
